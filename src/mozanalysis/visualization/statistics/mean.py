...
timeseries_mean_individual = dedent(
    f"""\
...
timeseries_mean_difference = dedent(
    f"""\
...
timeseries_mean_relative = dedent(
    f"""\
...
onetime_mean_individual = dedent(
    f"""\
...
onetime_mean_difference = dedent(
    f"""\
